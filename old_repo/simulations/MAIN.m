...
% Generate rock properties realizations
make_SPE10_realizations
...
%% Make Rock
% Load porosity/permeability realizations from make_SPE10_realizations
load all_poro.mat 
load all_perm.mat
load all_perm_md.mat
...
for i=1:N
    for j=1:M
        ...
        saturation(i,:,j) = sol(i,j).s(:,2);   %collect co2 saturation states
    end
end
